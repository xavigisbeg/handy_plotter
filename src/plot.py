...
class HandyPlotter:
	"""Class to plot everything in a directory with the possibility of making
		more plots where data has been smoothed through averaging"""
	...
	def read_excels(self, path, xPos, yPos, xLim=None, nAvg=None):
		"""Read the excel and introduce the values"""
	...
	def avg_excels(self, inp, nAvg):
		"""LPF: Averages the f(t) function, to eliminate high frequencies"""
		av = []
	...
	def save_plot(self, xLim, yLim, xTicks, yTicks, plt, path):
